...
void ssd1306_SetPresent(void)
{
    ...
    ssd1306_WriteString("CO2, T, H", Font_11x18, White);
    ssd1306_SetCursor(28, 16);
...
void ssd1306_Proc(void)
{
	...
	if(timeout_type+500 <= HAL_GetTick())
	{
        ...
        if(dev_var.set_ASC){
            ...
            sprintf(buffer, "SerNum: %d ASC", Setup.SerialId);
            ssd1306_WriteString(buffer, Font_7x10, White);
        } else {
            ssd1306_SetCursor(10, 0);
            sprintf(buffer, "SerNum: %d", Setup.SerialId);
            ssd1306_WriteString(buffer, Font_7x10, White);
        }
        ...
        ssd1306_SetCursor(54, 16);
        sprintf(buffer, "%d", dev_var.co2);
        ssd1306_WriteString(buffer, Font_16x26, White);
        
        ssd1306_SetCursor(10, 45);
        sprintf(buffer, "T:%d H:%d", dev_var.temp, dev_var.hum);
        ssd1306_WriteString(buffer, Font_11x18, White);
