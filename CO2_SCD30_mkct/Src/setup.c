...
// Протокол обмена SBUS
// Передача данных из буфера в CAN
//void UCA_Tx_USART2( void * addr )
//{
//	SBUS * state = addr;
//	int i = 0;
//	int len = state->TxLen;
...
//        LL_USART_TransmitData8(USART2, state->TxBuf[i++]);
//    }
//}

// Инициализация протокола SBUS для линии CAN
//void UCA_Init(void)
//{
//	SBUS_Init( &sbusChan1, MSG_PCONTROL_RECV_1, MSG_PCONTROL_SEND_1 );
//	sbusChan1.TxFunc = &UCA_Tx_USART2;
//}
